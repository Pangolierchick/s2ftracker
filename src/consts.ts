...
export const PLAYERS_DATA_JSON_FILENAME = 'players.json';
export const AUCTION_DATA_JSON_FILENAME = 'auction.json';
export const DEFAULT_FILTER_FILEPATH    = 'filter.json';

export const FETCH_PLAYERS_TIMEOUT = 1000 * 60 * 60 * 2; // 2 hours
export const FETCH_AUCTION_TIMEOUT = 1000 * 60 * 60 * 6; // 6 hours
export const BACKUP_TIMEOUT        = 1000 * 60 * 60 * 8;
